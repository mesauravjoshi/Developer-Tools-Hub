  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {displayResponse && (
          <button
            className="group relative inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-emerald-500 to-teal-500 px-4 py-2 font-semibold text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 overflow-hidden"

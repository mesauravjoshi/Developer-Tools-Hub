...
import { validateURL } from '@/components/Utils/ValidateURL';
...
export default function Get() {
  ...
  const handleSendReq = (e: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <>
      <div>
        {/* Slider code */}
        <Slider sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
        ...
        <div className="lg:pl-72">
          ...
          <main className="py-4">
            <div className="px-4 sm:px-6 lg:px-8">
              ...
              <h1 className="text-gray-300 dark:text-violet-900 text-3xl font-bold">Get </h1>
              {/* API Input */}

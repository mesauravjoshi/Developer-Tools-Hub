  ...
  return (
    <div className="bg-gray-900">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/25">
                ...
                <div className="py-6">
                  <Link
                    to={'/signup'}
                    clLinkssName="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-gray-800"
                  >
                    Log in
                  </Link>
                </div>
      ...
      <div className="relative isolate overflow-hidden pt-14">
        <img
          alt=""
          src="https://images.unsplash.com/photo-1628277613967-6abca504d0ac?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
